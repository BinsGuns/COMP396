...
public class TargetLock : MonoBehaviour
{
    [Header("Objects")]
    [Space]
    public  Camera mainCamera;            // your main camera object.
    [HideInInspector] public CinemachineFreeLook cinemachineFreeLook; //cinemachine free lock camera object.
   ...
   // private CinemachineFreeLook cm;
    ...
    void Start()
    {
       ...
       // mainCamera = GameObject.FindGameObjectWithTag("MainCamera").GetComponent<Camera>();
        cinemachineFreeLook = GameObject.FindGameObjectWithTag("Camera").GetComponent<CinemachineFreeLook>();
        cinemachineFreeLook.m_XAxis.m_InputAxisName = "";
        cinemachineFreeLook.m_YAxis.m_InputAxisName = "";

         // cm = GameObject.FindGameObjectWithTag("Camera").GetComponent<CinemachineFreeLook>();
         //
