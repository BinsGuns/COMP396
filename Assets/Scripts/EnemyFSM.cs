...
public class EnemyFSM : MonoBehaviour
{
    ...
    private CharacterMovementMultiplayer characterMovementMultiplayer;
    ...
    void Update()
    {
        if (GameObject.FindGameObjectWithTag("Player") && !isPlayerFound)
        {  
            isPlayerFound = true;
            player = GameObject.FindGameObjectWithTag("Player").gameObject.transform;

            if (GameObject.FindGameObjectWithTag("Player").GetComponent<CharacterMovement>() != null)
                characterMovement = GameObject.FindGameObjectWithTag("Player").GetComponent<CharacterMovement>();
            if (GameObject.FindGameObjectWithTag("Player").GetComponent<CharacterMovementMultiplayer>() != null)
                characterMovementMultiplayer = GameObject.FindGameObjectWithTag("Player")
                    .GetComponent<CharacterMovementMultiplayer>();
        }
        ...
        if (isAttackedByPlayer == false && !playerInSightRange && !playerInAttackRange && !enemyIsHurt && !isTimeToIdle && !IsDead)
        {
            ...
            {
                if(characterMovement) characterMovement.inCombat = false;
                if(characterMovementMultiplayer) characterMovementMultiplayer.inCombat = false;
        ...
        if (isAttackedByPlayer == true || playerInSightRange && !playerInAttackRange && !enemyIsHurt && !isTimeToIdle && !IsDead)
        {
            ...
            if(characterMovement) characterMovement.inCombat = true;
            if(characterMovementMultiplayer) characterMovementMultiplayer.inCombat = true;
